    ...
    var _tab = {
        ...
        createTabDom: function() {
            ...
            var tpl = [
            		...
            		'<ul>',
            		'<li class="kit-item" data-target="refresh">刷新 当前</li>',
            		'<li class="kit-line"></li>',
            		'<li class="kit-item" data-target="closeCurrent">关闭 当前</li>',
            		'<li class="kit-item" data-target="closeOther">关闭 其他</li>',
            		'<li class="kit-line"></li>',
            		'<li class="kit-item" data-target="closeAll">关闭 所有</li>',
            		'</ul>',
            		'</div>',
        ...
        tabAdd: function(options) {
            ...
            if (icon) {
                if (icon.indexOf('fa-') !== -1) {
                    ...
                    titleHtm.push('<i class="icon iconfont">' + icon + '</i>');
                }
            }
            titleHtm.push('&nbsp;' + title);
